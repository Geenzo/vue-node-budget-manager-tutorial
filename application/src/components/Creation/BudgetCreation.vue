  ...
  <div class="l-budget-creation">
      <v-layout row wrap>
          <span class="md-budget-state-hint uppercased white--text">status</span>
            ...
            <v-layout row wrap v-for="item in budget.items" class="1-budget-item" :key="item.id">
                <v-flex xs12 md1>
                ...
                <v-flex xs12 md3 offset-md1>
                    <v-text-field label="Title"
                                ...
                                v-model="item.title"
                                required
                                color="lighten-blue lighten-1">
                    </v-text-field>
                </v-flex>

                <v-flex cs12 md1 offset-md1>
            ...
            <v-flex xs12 md2 offset-md10>
                <v-btn block color="md-add-item-btn light-blue lighten-1" @client.native="addItem()">Add item</v-btn>
            </v-flex>

            <v-flex xs12 md2 offset-md-10>
